      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6 px-0 sm:px-2">
        {primaryModules.map((item) => (
          <Link
            key={item.title}
            to={item.path}
            className={`group relative overflow-hidden ${item.bgLight} p-6 rounded-2xl shadow-md shadow-gray-300/50 dark:shadow-gray-900/40 border border-gray-200/80 dark:border-gray-700/50 hover:shadow-lg hover:shadow-gray-400/40 dark:hover:shadow-gray-900/60 transition-all duration-300 flex items-start gap-4`}
          >
            ...
            <div className="relative z-10">
              <div className={`p-3 rounded-2xl bg-gray-50 dark:bg-gray-900/60 border border-gray-200 dark:border-gray-700/60 w-fit mb-3 text-lg ${item.iconText} group-hover:scale-110 transition-transform`}>
                {(() => {
        ...
        {/* Headline before gated features */}
